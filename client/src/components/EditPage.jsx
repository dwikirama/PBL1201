      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-lg border border-[#d4c2fc]">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-xs text-[#998fc7] mt-1">ID Token: <span className="font-mono">{car.token}</span></p>
          </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex gap-4 pt-4 border-t border-[#f9f5ff]">
            <button 
              type="button"
              onClick={onCancel} 
              className="flex-1 px-4 py-3 border border-[#d4c2fc] rounded-xl font-bold text-[#998fc7] hover:bg-[#f9f5ff] hover:text-[#14248a] transition-colors"
            >
              Batal
            </button>
            <button 
              type="submit" 
              className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-[#14248a] text-white rounded-xl font-bold hover:bg-[#28262c] transition-all shadow-lg shadow-[#14248a]/20"
            >
